...
import 'package:pigemshubshop/app/pages/profile/widgets/action_row.dart';
import 'package:pigemshubshop/app/pages/profile/widgets/edit_profile_dialog.dart';
import 'package:pigemshubshop/app/pages/profile/widgets/personal_info_tile.dart';
import 'package:pigemshubshop/app/pages/profile/widgets/profile_picture_avatar.dart';
                  ...
                  ActionRow(
                    ...
                    onTap: () {
                      ...
                      PiAnalyticsServiceImpl().triggerLogEvent(
                        event: PiAnalyticsEnum.logout,
                        metaData: {
                          "logoutEvent": value.account.emailAddress,
                        },
                      );
                    },
                  ),
