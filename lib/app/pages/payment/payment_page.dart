import 'package:pigemshubshop/app/pages/payment/widgets/select_payment_method.dart';
                    ...
                    children: [
                      ...
                      SelectPaymentMethod(
                        ...
                        selectPaymentMethod: () async {
                          var result =
                              await NavigateRoute.toManagePaymentMethod(context: context, returnPaymentMethod: true);
                          setState(() {
                              ...
                              : () async {
                                  ...
                                  try {
                                    ...
                                    await value.payCheckout().whenComplete(() {
                                      context
                                          .read<CartProvider>()
                                          .getCart(accountId: FirebaseAuth.instance.currentUser!.uid);
