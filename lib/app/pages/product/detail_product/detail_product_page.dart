import 'package:pigemshubshop/app/pages/product/detail_product/widgets/detail_action_button.dart';
import 'package:pigemshubshop/app/pages/product/detail_product/widgets/detail_product_image_card.dart';
import 'package:pigemshubshop/app/pages/product/detail_product/widgets/detail_rating_review.dart';
import 'package:pigemshubshop/app/pages/product/detail_product/widgets/detail_text_space_between..dart';
import 'package:pigemshubshop/app/pages/product/detail_product/widgets/user_action_button.dart';
...
import 'package:pigemshubshop/app/widgets/cart/cart_badge.dart';
import 'package:pigemshubshop/app/widgets/product_review_card.dart';
                  ...
                  : DetailActionButton(
                      ...
                      onTapEditProduct: () {
                        PiAnalyticsServiceImpl().triggerLogEvent(
                          event: PiAnalyticsEnum.productEditScreen,
                          metaData: {
                            "itemPressed": value.detailProduct!.productName.toString(),
                            "userType":
                            FlavorConfig.instance.flavor.roleValue.toString(),
                          },
                        );
