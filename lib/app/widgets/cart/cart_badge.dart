...
import 'package:pigemshubshop/app/widgets/cart/cart_container.dart';
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                    onPressed: () {
                                      ...
                                      checkoutProvider.start(
                                          cart: value.listCart,
                                          account: account);

                                      NavigateRoute.toCheckout(
                                          context: context);
                                    },
                                    child: Text(
                                        'Checkout (${value.countCart.toNumericFormat()})'),
                                  ),
                                ],
                              ),
                          ],
