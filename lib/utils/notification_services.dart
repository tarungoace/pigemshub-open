...
import '../app/constants/pi_keys.dart';
import '../routes.dart';
...
class NotificationServices {
  ...
  void handleMessage(BuildContext context, RemoteMessage message) {
    if (message.data['productAvailable'] == "true") {
      Navigator.of(PiKeys.navigatorKey.currentState!.context).pushNamed(
        RouteName.kDetailProduct,
        arguments: message.data['productID'],
      );
    }
  }
